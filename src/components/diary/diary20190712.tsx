...
const Diary20190712: React.FC = () => {
  return (
    <div className='diary'>
        <h1>タグを分類するための&nbsp;JSON&nbsp;生成とエンドポイントの修正</h1>
        ...
        <span className="code__with-order">-&nbsp;/2019-07-12</span><br />
        <span className="code__with-order">+&nbsp;/diary/2019-07-12</span><br />
        </code></p>
        
        こうすることで、&nbsp;<span className="inline-code">/tag/**</span>&nbsp;が切りやすくなるという次第である
        <br />
        ...
        <br />
        そのため、&nbsp;<s>（今回ほどひどい設計はしないまでも）</s>&nbsp;ある程度最初にエンドポイントを設計して、あとは柔軟に対応していく必要がある
        <br />
        &nbsp;
        <br />

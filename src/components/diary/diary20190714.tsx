...
const Diary20190714: React.FC = () => {
  return (
    <div className='diary'>
        <h1>Github&nbsp;からセキュリティ脆弱性の通知がきたとき</h1>
        
        タグ&nbsp;<Link to='/tag/1'><span className='inline-code'>このサイトの生い立ち</span></Link>&nbsp;<Link to='/tag/3'><span className='inline-code'>Github</span></Link>
        <br />
        <h2>背景</h2>
        
        ある日&nbsp;Github&nbsp;をみているとセキュリティ脆弱性に関する警告が出ていた
        <br />
        <img src="/static/diary/2019-07-14/security-alert.png" alt="" />
        <br />
        これに対策する
        <br />
        <h2>結果</h2>
        ...
        <br />
        <img src="/static/diary/2019-07-14/warned-module.png" alt="" />
        <br />
        このようにエラーモジュール一覧が表示されているので選択すると解消方法が記載されている
        <br />
        <img src="/static/diary/2019-07-14/resolve-security-alert.png" alt="" />
        <br />
        この通りに対応すればいける
        <br />
        &nbsp;
        ...
        <br />
        <img src="/static/diary/2019-07-14/after-create-automated-security-fix.png" alt="" />
        <br />
        実際に&nbsp;Pull&nbsp;Request&nbsp;ができていて
        <br />
        <img src="/static/diary/2019-07-14/pull-request.png" alt="" />
        <br />
        クリックすると、&nbsp;Bot&nbsp;によって生成されていることがわかる
        <br />
        <img src="/static/diary/2019-07-14/pr-by-bot.png" alt="" />
        <br />
        <h2>補足</h2>
        ...
        <br />
        <img src="/static/diary/2019-07-14/dismiss.png" alt="" />
        <br />

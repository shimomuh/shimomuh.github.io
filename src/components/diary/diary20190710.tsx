...
const Diary20190710: React.FC = () => {
  return (
    <div className='diary'>
        ...
        <span className="code__with-order"></span><br />
        <span className="code__with-order">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="syntax--def">def</span>&nbsp;render</span><br />
        ...
        <span className="code__with-order">&nbsp;&nbsp;::SubDomain::GeneralDomain::Template.new(value&nbsp;&quot;src/components/diary/diary#<span className="syntax--braces">&#123;</span>date_no_hyphen<span className="syntax--braces">&#125;</span>.tsx&quot;&nbsp;&#39;templates/src/components/diary/template.tsx.erb&#39;).render</span><br />
        <span className="code__with-order"><span className="syntax--end">end</span></span><br />
        </code></p>

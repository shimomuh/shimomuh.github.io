...
const Diary20190721: React.FC = () => {
  return (
    <div className='diary'>
        <h1>Google&nbsp;Analytics&nbsp;のタグを埋め込んで訪問者を分析しよう</h1>
        
        タグ&nbsp;<Link to='/tag/1'><span className='inline-code'>このサイトの生い立ち</span></Link>&nbsp;<Link to='/tag/14'><span className='inline-code'>分析</span></Link>
        <br />
        <h2>対象者</h2>
        ...
        この記事時点での最新なので、見た人によっては最新じゃないかもめ&nbsp;&#x1f647;
        <br />
        ...
        <br />
        <img src="/static/diary/2019-07-21/analytics.png" alt="" />
        <br />
        その後に利用規約が出てくるので&nbsp;<s>読み飛ばして</s>&nbsp;内容を確認しながらチェックを入れていく
        <br />
        この当時は&nbsp;GDPR&nbsp;が出てそういえば1年前にそんなの適応されたなーとか思い出した
        <br />
        &nbsp;
        <br />
        あとは以下のトラッキングコードに書かれたコードをコピペで&nbsp;&#x1f44c;
        <br />
        <img src="/static/diary/2019-07-21/tracking-code.png" alt="" />
        <br />
        <h2>おまけ</h2>
        ...
        <br />
        <img src="/static/diary/2019-07-21/expiration.png" alt="" />
        <br />
        気にしない人はそのままで&nbsp;&#x1f44c;
      <br /><br />
      <div>

...
残念ながら&nbsp;CSS&nbsp;ハックは使うべきじゃない！方、&nbsp;JS&nbsp;でやるべきだろ！派の方は対象外。<br />

<h2>背景</h2>

ブラウザでなんとなく確認したら画像がとんでもないことになっていたのを見つけた...<br />

<img src="/diary/2019-07-04/browser-diff-before.png" alt="" /><br />

スタイルはあくまで&nbsp;CSS&nbsp;が担当すべき派の僕としては&nbsp;CSS&nbsp;をハックしてでも頑張るという方向で対処することにした<br />
...
<a href={"https://github.com/shimomuh/shimomuh.github.io/commit/ff334744a9283e290e7dff3baaa539ee8a21f6b3"}>成果→</a><br />
...
<a href={"https://kuroko-role.co.jp/css-html/browser-hack2018/"}>ブラウザ別に適用させるCSSハック2018&nbsp;|&nbsp;株式会社クロコロール</a>&nbsp;を丸パクリ...<br />

<img src="/diary/2019-07-04/browser-diff-after.png" alt="" /><br />
      <br />
      <div>
        <Link to='/'>戻る</Link>
      </div>

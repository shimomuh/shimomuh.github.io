...
const Diary20190709: React.FC = () => {
  return (
    <div className='diary'>
        <h1>Markdown&nbsp;から&nbsp;TypeScript&nbsp;に書き換えるコンバーターのリファクタ</h1>
        ...
        <ul><li>DDD&nbsp;の実践をしたい</li>
        <li>DDD&nbsp;を実践している</li>
        <li>リファクタリングを考えている</li>
        </ul>
        そんな人
        <br />
        <h2>背景</h2>
        
        bin/make-tsx.rb&nbsp;というファイルですでに&nbsp;Markdown&nbsp;to&nbsp;TypeScript&nbsp;なコンバーターは&nbsp;<a href="http://localhost:3000/2019-06-29">【暫定版】ruby&nbsp;で&nbsp;React&nbsp;に載せるための&nbsp;Markdown&nbsp;コンバーターを実装する</a>&nbsp;で実践し改善してきたのだが、テストも全くないのでそろそろ拡張が限界にきている（品質が保証できなくなっている）
        <br />
        &nbsp;
        <br />
        ...
        今の&nbsp;<a href="https://github.com/shimomuh/shimomuh.github.io/blob/feature/2019-07-08/bin/make-tsx.rb">make-tsx.rb</a>&nbsp;を紐解いて設計を考える
        <br />
        ちなみに、設計は&nbsp;DDD&nbsp;に基づく
        <br />
        DDD&nbsp;については&nbsp;<a href="https://codezine.jp/article/detail/9744">実践DDD本&nbsp;第2章「ドメイン」「サブドメイン」「境界づけられたコンテキスト」を読み解く</a>&nbsp;あたりを参考にすべし
        <br />
        ...
        ともあれ設計した結果は以下の通り
        <br />
        <ul><li>1記事を文字列配列として渡し</li>
        <li>文字列配列に対して複数行にまたがるマークダウン記法処理をする</li>
        <li>文字列に対して1行に関するマークダウン処理をする</li>
        <li>文字をエスケープする</li>
        </ul>
        ...
        <span className="code__with-order">class&nbsp;StringArrayParser</span><br />
        <span className="code__with-order">&nbsp;&nbsp;def&nbsp;self.parse(str_array)</span><br />
        <span className="code__with-order">&nbsp;&nbsp;&nbsp;&nbsp;string_array.each&nbsp;do&nbsp;|str|</span><br />
        ...
        <span className="code__with-order">&nbsp;&nbsp;class&nbsp;StringParser</span><br />
        <span className="code__with-order">&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;self.parse(str)</span><br />

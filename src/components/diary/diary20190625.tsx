...
const Diary20190625: React.FC = () => {
  return (
    <div className='diary'>
        ...
        <br />
        リポジトリ内の構成や&nbsp;react-dom&nbsp;にまつわるコンポーネントなんかは初めからサンプルは全無視して作ったが、サンプルをみながら作る方がよろしい（<s>syntax&nbsp;エラーで何度もビルドに失敗したのは内緒（￣b￣ｼｰｯ</s>）
        <br />
        <h3>試運転</h3>
        
        test-react-sample&nbsp;というディレクトリでサンプルはすでに試したことだったが、自分の作った&nbsp;index.tsx&nbsp;を&nbsp;<span className="inline-code">npm&nbsp;run&nbsp;start</span>&nbsp;してローカルで動かした（一安心）
        <br />
        <h3>ビルド</h3>

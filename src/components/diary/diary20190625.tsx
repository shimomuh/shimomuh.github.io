...
ここに<a href={"https://shimomuh.github.io"} target="_blank">このホームページ</a>が誕生した。<br />

とはいえ、これで終わると何も伝わらないので、やったことを書く<br />

<h2>過程<br /></h2>

<h3>Github&nbsp;Pages<br /></h3>

過去に&nbsp;<a href={"https://pages.github.com/"} target="_blank">Github&nbsp;Pages</a>&nbsp;でサイトを作ったことはあったのでサイト構築については割愛。<br />
...
stable&nbsp;でなくてもよかったので&nbsp;<a href={"https://nodejs.org/ja/"} target="_blank">nodejs</a>&nbsp;から最新版を取得した（もちろん&nbsp;ndenv&nbsp;を使ってね）<br />

<h3>Typescript&nbsp;/&nbsp;create-react-app<br /></h3>
...
リポジトリ内の構成や&nbsp;react-dom&nbsp;にまつわるコンポーネントなんかは初めからサンプルは全無視して作ったが、サンプルをみながら作る方がよろしい（~syntax&nbsp;エラーで何度もビルドに失敗したのは内緒（￣b￣ｼｰｯ~）<br />
...
<h3><span className="inline-code">npm&nbsp;run&nbsp;ejest</span><br /></h3>

ビルド先を変更したいが変更ファイルらしきものがなくて&nbsp;tsconfig.json&nbsp;をいじるのかなと迷走しかけた<br />

が、怠け者の僕はすぐに&nbsp;Google&nbsp;先生に聞いたら先人がいた<br />

<a href={"https://qiita.com/yakimeron/items/7a4f8d9e70a4a2b1b96b"} target="_blank">create-react-appでbuild先のパスを変更する</a><br />
...
まず僕は&nbsp;<a href={"https://pages.github.com/"} target="_blank">Github&nbsp;Pages&nbsp;の存在</a>&nbsp;を知っていた（これはなんて幸運なことだ！）<br />

次に、過去に業務レベルで&nbsp;ReactJS&nbsp;をバリバリ触っていた<br />

さらには、ついこの前まで隣の席で一緒にお仕事をしていた&nbsp;<a href={"https://github.com/Takepepe"} target="_blank">@Takepepe</a>&nbsp;さんが<a href={"https://www.amazon.co.jp/dp/483996937X?fbclid=IwAR2f8NdtIH6YFiojk-dgtCWEg-dibkggPCTVtEqR73DEdSRiM1Q6iotC0c8"} target="_blank">実践TypeScript&nbsp;~	BFFとNext.js&amp;Nuxt.jsの型定義~</a>&nbsp;という本を出すと聞いて、久々に書こうと触発されたのもあるかもしれない（謝謝）<br />
